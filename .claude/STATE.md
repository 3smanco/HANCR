...
- **فرع `feat/rider-journey-c-to-f` (3 commits: 87f7e09 ثم 3ac11c3 ثم f57accc): C1 + E + F‑جزئي — مُتحقَّق، غير مدموج/منشور** (يحتاج migration `1782500000000-AddOrderCancellation` عند النشر).
- **⏭️ المتبقّي من الخطة:** **C4** ورقة دفع pre/post-pay (عميقة — checkout البوابة) · **D** الإيصال الكامل + تحسين شاشة التقييم + ما بعد التقييم (أميال/إعادة حجز) · **F‑بقية** (صقل المزايدة، إبراز OTP، حركة أميال الولاء). مؤجَّل أيضاً: pickupZones registry، perMinuteWait للعرض الحيّ، الخصم الفعلي لرسم الإلغاء من المحفظة.
