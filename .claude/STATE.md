...
- **⏭️ متبقٍّ (محجوب بإجراء المالك فقط):** نداءات الدفع/الرسائل/الترجمة الفعلية (مفاتيح + حسابات — طبقات القرار جاهزة) · كونسيرج فنادق (حقل + قرار منتج) · كرة أرضية 3D (تجاوزناها — المسطّح مُنفَّذ ومُفضَّل).
