...
- **⏭️ متبقٍّ (اختياري/محجوب):** كرة أرضية 3D (المستخدم فضّل المسطّح — مُنفَّذ) · كونسيرج فنادق · عمليات عبر-المدن · ربط نداءات الدفع/الرسائل الفعلية (محجوب: حسابات تاجر + مفاتيح المالك).
