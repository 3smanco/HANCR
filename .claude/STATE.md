...
- **🔵 Phase 1 (هيكل command-center + الشريط العلوي) — جارية:**
  ...
  - **⏭️ متبقّي 1c:** ربط `useGlobalScope` بالعروض (تمرير countryIso/cityId للاستعلامات) + جرس SOS حيّ (FCM) + إعادة تنظيم القائمة الجانبية للأقسام الـ16 + هجرة بقية المكوّنات للثيم. ثم Phase 2 (Geo-Radar) و3 (BI) و4 (مالي) و5 (CRM).
