...
const Map<String, Map<String, String>> _t = {
  ...
  'quietRide': {'ar': 'رحلة هادئة', 'en': 'Quiet ride'},
  'audioOff': {'ar': 'بلا صوت', 'en': 'Audio off'},
  ...
  'tripHistory': {'ar': 'سجلّ الرحلات', 'en': 'Trip history'},
  'noTrips': {'ar': 'لا توجد رحلات مكتملة بعد', 'en': 'No completed trips yet'},
  'pastTrips': {'ar': 'رحلاتك المكتملة', 'en': 'Your completed trips'},
  ...
  'rateRiderTitle': {'ar': 'كيف كان الراكب؟', 'en': 'How was your rider?'},
  'submitRating': {'ar': 'إرسال التقييم', 'en': 'Submit rating'},
  'skip': {'ar': 'تخطّي', 'en': 'Skip'},
  'rider': {'ar': 'الراكب', 'en': 'Rider'},
  'announcements': {'ar': 'الأخبار والإعلانات', 'en': 'News & announcements'},
  'noAnnouncements': {'ar': 'لا توجد إعلانات حالياً', 'en': 'No announcements yet'},
  'learnMore': {'ar': 'اعرف المزيد', 'en': 'Learn more'},
  // ─── Help center + invite ───
  'helpCenter': {'ar': 'مركز المساعدة', 'en': 'Help center'},
  'inviteCaptains': {'ar': 'ادعُ كباتن جدد', 'en': 'Invite new captains'},
  'inviteDesc': {'ar': 'شارك تطبيق HANCR Captain مع أصدقائك السائقين وساعدهم على الانضمام لأسطولنا.', 'en': 'Share the HANCR Captain app with your driver friends and help them join our fleet.'},
  'inviteShareText': {'ar': 'انضم لكباتن HANCR واكسب دخلاً مرناً! حمّل التطبيق:', 'en': 'Join HANCR captains and earn flexibly! Download the app:'},
  'shareApp': {'ar': 'مشاركة التطبيق', 'en': 'Share app'},
  'linkCopied': {'ar': 'تم نسخ الرابط', 'en': 'Link copied'},
  'faq': {'ar': 'الأسئلة الشائعة', 'en': 'FAQ'},
  'faqQ1': {'ar': 'كيف أبدأ استقبال الطلبات؟', 'en': 'How do I start receiving orders?'},
  'faqA1': {'ar': 'فعّل وضع «متصل» من الشاشة الرئيسية بعد اعتماد مستنداتك، وستصلك الطلبات القريبة تلقائياً.', 'en': 'Turn on "Online" from the home screen after your documents are approved — nearby orders arrive automatically.'},
  'faqQ2': {'ar': 'متى تُعتمد مستنداتي؟', 'en': 'When are my documents approved?'},
  'faqA2': {'ar': 'يراجع فريقنا المستندات عادةً خلال 24–48 ساعة. تابع الحالة من قسم المستندات.', 'en': 'Our team usually reviews documents within 24–48 hours. Track the status in the Documents section.'},
  'faqQ3': {'ar': 'كيف أسحب أرباحي؟', 'en': 'How do I withdraw earnings?'},
  'faqA3': {'ar': 'أضف طريقة سحب (بنك/مدى/STC Pay) من المحفظة، ثم اطلب السحب — الحد الأدنى 50.', 'en': 'Add a payout method (bank/Mada/STC Pay) in the wallet, then request a withdrawal — minimum 50.'},
  'faqQ4': {'ar': 'كيف تعمل نجوم الكابتن؟', 'en': 'How do Captain Stars work?'},
  'faqA4': {'ar': 'تكسب نجوماً من التقييم العالي والرحلات الطويلة وساعات الذروة وعدم الإلغاء — وكلما زادت نجومك قلّت عمولتك.', 'en': 'You earn stars from high ratings, long trips, peak hours, and not cancelling — more stars means lower commission.'},
  'contactUs': {'ar': 'تواصل معنا', 'en': 'Contact us'},
  'contactEmail': {'ar': 'راسلنا عبر البريد', 'en': 'Email us'},
  ...
  'selfieHint': {'ar': 'التقط صورة واضحة لوجهك للتحقّق من هويتك', 'en': 'Take a clear photo of your face to verify your identity'},
  'selfieTapHint': {'ar': 'اضغط لالتقاط سيلفي', 'en': 'Tap to take a selfie'},
  'optional': {'ar': 'اختياري', 'en': 'optional'},
  'reviewNote': {'ar': 'بعد الإرسال يراجع فريقنا مستنداتك وتُفعَّل حسابك خلال وقت قصير.', 'en': 'After submitting, our team reviews your documents and activates your account shortly.'},
