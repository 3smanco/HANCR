...
const Map<String, Map<String, String>> _t = {
  ...
  'parcel': {'ar': 'طرد', 'en': 'Parcel', 'ur': 'پارسل', 'hi': 'पार्सل', 'bn': 'পার্সেল', 'fil': 'Parcel', 'fr': 'Colis', 'tr': 'Paket'},
  ...
  'daySun': {'ar': 'الأحد', 'en': 'Sun', 'ur': 'اتوار', 'hi': 'रवि', 'bn': 'রবি', 'fil': 'Lin', 'fr': 'Dim', 'tr': 'Paz'},
  'dayMon': {'ar': 'الإثنين', 'en': 'Mon', 'ur': 'پیر', 'hi': 'सोम', 'bn': 'সোম', 'fil': 'Lun', 'fr': 'Lun', 'tr': 'Pzt'},
  'dayTue': {'ar': 'الثلاثاء', 'en': 'Tue', 'ur': 'منگل', 'hi': 'मंगल', 'bn': 'মঙ্গল', 'fil': 'Mar', 'fr': 'Mar', 'tr': 'Sal'},
  'dayWed': {'ar': 'الأربعاء', 'en': 'Wed', 'ur': 'بدھ', 'hi': 'बुध', 'bn': 'বুধ', 'fil': 'Miy', 'fr': 'Mer', 'tr': 'Çar'},
  'dayThu': {'ar': 'الخميس', 'en': 'Thu', 'ur': 'جمعرات', 'hi': 'गुरु', 'bn': 'বৃহঃ', 'fil': 'Huw', 'fr': 'Jeu', 'tr': 'Per'},
  'dayFri': {'ar': 'الجمعة', 'en': 'Fri', 'ur': 'جمعہ', 'hi': 'शुक्र', 'bn': 'শুক্র', 'fil': 'Biy', 'fr': 'Ven', 'tr': 'Cum'},
  'daySat': {'ar': 'السبت', 'en': 'Sat', 'ur': 'ہفتہ', 'hi': 'शनि', 'bn': 'শনি', 'fil': 'Sab', 'fr': 'Sam', 'tr': 'Cmt'},
  ...
  // ─── Phase E1: Carpool ───
  'carpool': {'ar': 'مشاركة الرحلة', 'en': 'Carpool', 'ur': 'سواری شیئر', 'hi': 'राइड शेयर', 'bn': 'রাইড শেয়ার', 'fil': 'Carpool', 'fr': 'Covoiturage', 'tr': 'Yolculuk paylaşımı'},
  'carpoolHowItWorks': {'ar': 'شارك رحلتك مع راكب آخر بنفس المسار ووفّر 30-40%', 'en': 'Share with another rider on the same route and save 30–40%', 'ur': 'اسی راستے پر دوسرے سواری کے ساتھ شیئر کریں', 'hi': 'समान मार्ग पर साथी के साथ शेयर करें', 'bn': 'একই পথে শেয়ার করুন', 'fil': 'Magbahagi sa parehong ruta', 'fr': 'Partagez votre trajet', 'tr': 'Aynı yolda paylaş'},
  'pickOriginAndDest': {'ar': 'اختر الانطلاق والوجهة', 'en': 'Pick origin and destination', 'ur': 'ابتدا اور منزل منتخب کریں', 'hi': 'प्रारंभ और गंतव्य चुनें', 'bn': 'শুরু ও গন্তব্য বাছুন', 'fil': 'Pumili ng pinagmulan at destinasyon', 'fr': 'Choisissez départ et destination', 'tr': 'Başlangıç ve hedef seç'},
  'carpoolFutureTime': {'ar': 'اختر وقتاً بعد 5 دقائق على الأقل', 'en': 'Pick a time at least 5 min away', 'ur': 'کم از کم 5 منٹ بعد کا وقت', 'hi': 'कम से कम 5 मिनट बाद', 'bn': 'অন্তত ৫ মিনিট পরে', 'fil': '5 minuto mula ngayon', 'fr': 'Au moins 5 min plus tard', 'tr': 'En az 5 dakika sonra'},
  'maxRiders': {'ar': 'أقصى عدد ركاب', 'en': 'Max riders', 'ur': 'زیادہ سے زیادہ سواریاں', 'hi': 'अधिकतम राइडर', 'bn': 'সর্বাধিক যাত্রী', 'fil': 'Max na pasahero', 'fr': 'Passagers max', 'tr': 'Max yolcu'},
  'trustMode': {'ar': 'وضع الثقة', 'en': 'Trust mode', 'ur': 'بھروسے کا موڈ', 'hi': 'भरोसा मोड', 'bn': 'বিশ্বাস মোড', 'fil': 'Trust mode', 'fr': 'Confiance', 'tr': 'Güven modu'},
  'trust_open': {'ar': 'مفتوح للجميع', 'en': 'Open', 'ur': 'سب کے لیے', 'hi': 'सभी', 'bn': 'সবার জন্য', 'fil': 'Bukas', 'fr': 'Ouvert', 'tr': 'Açık'},
  'trust_women_only': {'ar': 'نساء فقط', 'en': 'Women only', 'ur': 'صرف خواتین', 'hi': 'केवल महिलाएँ', 'bn': 'শুধু নারী', 'fil': 'Babae lamang', 'fr': 'Femmes seulement', 'tr': 'Sadece kadınlar'},
  'trust_family': {'ar': 'عائلات', 'en': 'Family', 'ur': 'خاندان', 'hi': 'परिवार', 'bn': 'পরিবার', 'fil': 'Pamilya', 'fr': 'Famille', 'tr': 'Aile'},
  'requestCarpool': {'ar': 'طلب Carpool', 'en': 'Request carpool', 'ur': 'کاپول کی درخواست', 'hi': 'कारपूल अनुरोध', 'bn': 'কারপুল অনুরোধ', 'fil': 'Humiling ng carpool', 'fr': 'Demander', 'tr': 'Carpool iste'},
  'myCarpoolRequests': {'ar': 'طلباتي', 'en': 'My requests', 'ur': 'میری درخواستیں', 'hi': 'मेरे अनुरोध', 'bn': 'আমার অনুরোধ', 'fil': 'Aking mga kahilingan', 'fr': 'Mes demandes', 'tr': 'İsteklerim'},
  'noCarpoolRequests': {'ar': 'لا توجد طلبات', 'en': 'No requests yet', 'ur': 'کوئی درخواست نہیں', 'hi': 'कोई अनुरोध नहीं', 'bn': 'কোনো অনুরোধ নেই', 'fil': 'Wala pang kahilingan', 'fr': 'Aucune demande', 'tr': 'İstek yok'},
  'carpoolMatched': {'ar': 'تم العثور على شريك! 🎉', 'en': 'Match found! 🎉', 'ur': 'ساتھی مل گیا! 🎉', 'hi': 'साथी मिल गया! 🎉', 'bn': 'সঙ্গী পাওয়া গেছে! 🎉', 'fil': 'May katugma! 🎉', 'fr': 'Partenaire trouvé !', 'tr': 'Eşleşme bulundu!'},
  'carpoolPending': {'ar': 'بانتظار شريك...', 'en': 'Waiting for a partner...', 'ur': 'ساتھی کا انتظار...', 'hi': 'साथी की प्रतीक्षा...', 'bn': 'সঙ্গীর অপেক্ষায়...', 'fil': 'Naghihintay...', 'fr': 'En attente...', 'tr': 'Bekleniyor...'},
  'carpool_status_pending': {'ar': 'بانتظار', 'en': 'Pending', 'ur': 'زیر التواء', 'hi': 'लंबित', 'bn': 'অপেক্ষমাণ', 'fil': 'Naghihintay', 'fr': 'En attente', 'tr': 'Beklemede'},
  'carpool_status_matched': {'ar': 'مُطابَق ✓', 'en': 'Matched ✓', 'ur': 'میچ ✓', 'hi': 'मिलान ✓', 'bn': 'মিল ✓', 'fil': 'Tugma ✓', 'fr': 'Apparié ✓', 'tr': 'Eşleşti ✓'},
  'carpool_status_booked': {'ar': 'محجوز', 'en': 'Booked', 'ur': 'بک ہو گیا', 'hi': 'बुक', 'bn': 'বুক', 'fil': 'Naka-book', 'fr': 'Réservé', 'tr': 'Rezerve'},
  'carpool_status_expired': {'ar': 'انتهت', 'en': 'Expired', 'ur': 'ختم', 'hi': 'समाप्त', 'bn': 'মেয়াদোত্তীর্ণ', 'fil': 'Nag-expire', 'fr': 'Expiré', 'tr': 'Süresi doldu'},
  'carpool_status_cancelled': {'ar': 'ملغي', 'en': 'Cancelled', 'ur': 'منسوخ', 'hi': 'रद्द', 'bn': 'বাতিল', 'fil': 'Kanselado', 'fr': 'Annulé', 'tr': 'İptal'},
  'discountApplied': {'ar': 'الخصم المُطبَّق', 'en': 'Discount applied', 'ur': 'ڈسکاؤنٹ', 'hi': 'छूट लागू', 'bn': 'ছাড়', 'fil': 'Diskwento', 'fr': 'Remise appliquée', 'tr': 'İndirim uygulandı'},

  // ─── Phase E2: Grocery Run ───
  'groceryRun': {'ar': 'طلب بقالة', 'en': 'Grocery Run', 'ur': 'گروسری', 'hi': 'किराना', 'bn': 'মুদি', 'fil': 'Grocery', 'fr': 'Courses', 'tr': 'Market alışverişi'},
  'pickStore': {'ar': 'اختر المتجر', 'en': 'Pick store', 'ur': 'دکان منتخب کریں', 'hi': 'दुकान चुनें', 'bn': 'দোকান বাছুন', 'fil': 'Pumili ng tindahan', 'fr': 'Choisir le magasin', 'tr': 'Mağaza seç'},
  'deliverTo': {'ar': 'التوصيل إلى', 'en': 'Deliver to', 'ur': 'ڈیلیور کریں', 'hi': 'पहुँचाएँ', 'bn': 'পৌঁছান', 'fil': 'Ihatid sa', 'fr': 'Livrer à', 'tr': 'Teslimat adresi'},
  'pickStoreAndDeliverTo': {'ar': 'اختر المتجر وعنوان التوصيل', 'en': 'Pick store and delivery address', 'ur': 'دکان اور پتہ منتخب کریں', 'hi': 'दुकान और पता चुनें', 'bn': 'দোকান ও ঠিকানা বাছুন', 'fil': 'Pumili ng tindahan at address', 'fr': 'Choisir magasin et adresse', 'tr': 'Mağaza ve adres seç'},
  'shoppingList': {'ar': 'قائمة المشتريات', 'en': 'Shopping list', 'ur': 'خریداری کی فہرست', 'hi': 'खरीदारी सूची', 'bn': 'কেনাকাটার তালিকা', 'fil': 'Listahan ng bibilhin', 'fr': 'Liste de courses', 'tr': 'Alışveriş listesi'},
  'noItemsYet': {'ar': 'لا توجد عناصر بعد', 'en': 'No items yet', 'ur': 'ابھی کوئی شئے نہیں', 'hi': 'अभी कोई आइटम नहीं', 'bn': 'এখনো কোনো আইটেম নেই', 'fil': 'Wala pang item', 'fr': 'Aucun article', 'tr': 'Henüz ürün yok'},
  'addItem': {'ar': 'إضافة', 'en': 'Add', 'ur': 'شامل کریں', 'hi': 'जोड़ें', 'bn': 'যোগ করুন', 'fil': 'Idagdag', 'fr': 'Ajouter', 'tr': 'Ekle'},
  'addAtLeastOneItem': {'ar': 'أضف عنصراً واحداً على الأقل', 'en': 'Add at least one item', 'ur': 'کم از کم ایک شئے', 'hi': 'कम से कम एक आइटम', 'bn': 'অন্তত একটি আইটেম', 'fil': 'Magdagdag ng item', 'fr': 'Ajoutez au moins un article', 'tr': 'En az bir ürün ekle'},
  'itemName': {'ar': 'اسم العنصر', 'en': 'Item name', 'ur': 'شئے کا نام', 'hi': 'आइटम का नाम', 'bn': 'আইটেমের নাম', 'fil': 'Pangalan ng item', 'fr': 'Nom de l\'article', 'tr': 'Ürün adı'},
  'itemNoteOptional': {'ar': 'ملاحظة (اختياري) — ماركة/حجم', 'en': 'Note (optional) — brand, size', 'ur': 'نوٹ (اختیاری)', 'hi': 'नोट (वैकल्पिक)', 'bn': 'নোট (ঐচ্ছিক)', 'fil': 'Note (opsyonal)', 'fr': 'Note (facultatif)', 'tr': 'Not (isteğe bağlı)'},
  'budget': {'ar': 'الميزانية', 'en': 'Budget', 'ur': 'بجٹ', 'hi': 'बजट', 'bn': 'বাজেট', 'fil': 'Budget', 'fr': 'Budget', 'tr': 'Bütçe'},
  'budgetRequired': {'ar': 'حدّد ميزانية', 'en': 'Set a budget', 'ur': 'بجٹ مقرر کریں', 'hi': 'बजट तय करें', 'bn': 'বাজেট ঠিক করুন', 'fil': 'Magtakda ng budget', 'fr': 'Définissez un budget', 'tr': 'Bütçe belirle'},
  'orderGrocery': {'ar': 'اطلب البقالة', 'en': 'Order groceries', 'ur': 'گروسری آرڈر کریں', 'hi': 'किराना ऑर्डर करें', 'bn': 'মুদি অর্ডার', 'fil': 'I-order ang grocery', 'fr': 'Commander les courses', 'tr': 'Marketi sipariş et'},
  'groceryHint': {'ar': 'السائق سيشتري قائمتك ضمن الميزانية ويوصلها إليك', 'en': 'The driver will buy your list within budget and deliver to you', 'ur': 'ڈرائیور بجٹ کے اندر فہرست خرید کر پہنچائے گا', 'hi': 'ड्राइवर बजट के भीतर खरीदेगा और पहुँचाएगा', 'bn': 'চালক বাজেটের মধ্যে কিনে পৌঁছাবে', 'fil': 'Bibili at ihahatid sa loob ng budget', 'fr': 'Le chauffeur achètera votre liste et la livrera', 'tr': 'Sürücü bütçe içinde alıp getirir'},
  'groceryOrderPlaced': {'ar': 'تم إنشاء طلب البقالة', 'en': 'Grocery order placed', 'ur': 'گروسری آرڈر کر دیا', 'hi': 'किराना ऑर्डर हो गया', 'bn': 'মুদি অর্ডার হয়েছে', 'fil': 'Naka-order na', 'fr': 'Commande passée', 'tr': 'Sipariş verildi'},
  'myselfRecipient': {'ar': 'أنا — التسليم لي', 'en': 'Me — deliver to me', 'ur': 'میں — مجھے دیں', 'hi': 'मुझे — डिलीवर करें', 'bn': 'আমাকে — পৌঁছান', 'fil': 'Ako — sa akin', 'fr': 'Moi — livraison', 'tr': 'Bana teslim'},
  ...
  'orContinueWith': {'ar': 'أو تابع عبر', 'en': 'or continue with', 'ur': 'یا اس کے ساتھ جاری رکھیں', 'hi': 'या इसके साथ जारी रखें', 'bn': 'অথবা চালিয়ে যান', 'fil': 'o magpatuloy gamit ang', 'fr': 'ou continuer avec', 'tr': 'veya şununla devam et'},
  'comingSoonSocial': {'ar': 'الدخول عبر هذه الطريقة متاح قريباً', 'en': 'sign-in via this method is coming soon', 'ur': 'یہ طریقہ جلد دستیاب ہوگا', 'hi': 'यह तरीका जल्द उपलब्ध होगा', 'bn': 'এই পদ্ধতি শীঘ্রই আসছে', 'fil': 'malapit nang available ang paraang ito', 'fr': 'cette méthode arrive bientôt', 'tr': 'bu yöntem yakında geliyor'},
  'emailLoginTitle': {'ar': 'الدخول بالبريد', 'en': 'Sign in with email', 'ur': 'ای میل سے سائن ان', 'hi': 'ईमेल से साइन इन करें', 'bn': 'ইমেইল দিয়ে সাইন ইন', 'fil': 'Mag-sign in gamit ang email', 'fr': 'Connexion par e-mail', 'tr': 'E-posta ile giriş'},
  'emailLoginSub': {'ar': 'سنرسل لك رمز تحقّق إلى بريدك', 'en': 'We will send a verification code to your email', 'ur': 'ہم آپ کے ای میل پر کوڈ بھیجیں گے', 'hi': 'हम आपके ईमेल पर कोड भेजेंगे', 'bn': 'আমরা আপনার ইমেইলে কোড পাঠাব', 'fil': 'Magpapadala kami ng code sa iyong email', 'fr': 'Nous enverrons un code à votre e-mail', 'tr': 'E-postanıza bir kod göndereceğiz'},
  'sendCode': {'ar': 'إرسال الرمز', 'en': 'Send code', 'ur': 'کوڈ بھیجیں', 'hi': 'कोड भेजें', 'bn': 'কোড পাঠান', 'fil': 'Ipadala ang code', 'fr': 'Envoyer le code', 'tr': 'Kod gönder'},
  'addPhoneToComplete': {'ar': 'أضف رقم هاتفك لإكمال إنشاء الحساب', 'en': 'Add your phone number to complete your account', 'ur': 'اکاؤنٹ مکمل کرنے کے لیے فون نمبر شامل کریں', 'hi': 'खाता पूरा करने के लिए फ़ोन नंबर जोड़ें', 'bn': 'অ্যাকাউন্ট সম্পূর্ণ করতে ফোন নম্বর যোগ করুন', 'fil': 'Idagdag ang telepono para makumpleto ang account', 'fr': 'Ajoutez votre numéro pour compléter le compte', 'tr': 'Hesabı tamamlamak için telefon ekleyin'},
  ...
  'startsFrom': {'ar': 'تبدأ من', 'en': 'From', 'ur': 'سے شروع', 'hi': 'से शुरू', 'bn': 'থেকে শুরু', 'fil': 'Mula sa', 'fr': 'À partir de', 'tr': 'Başlangıç'},
  'selectedDestination': {'ar': 'الوجهة المحددة', 'en': 'Selected destination', 'ur': 'منتخب منزل', 'hi': 'चयनित गंतव्य', 'bn': 'নির্বাচিত গন্তব্য', 'fil': 'Napiling patutunguhan', 'fr': 'Destination sélectionnée', 'tr': 'Seçilen hedef'},
  'moreOptions': {'ar': 'خيارات إضافية', 'en': 'More options', 'ur': 'مزید اختیارات', 'hi': 'अधिक विकल्प', 'bn': 'আরও বিকল্প', 'fil': 'Higit pang opsyon', 'fr': 'Plus d\'options', 'tr': 'Daha fazla seçenek'},
  'economySection': {'ar': 'اقتصادي', 'en': 'Economy', 'ur': 'اکانمی', 'hi': 'इकोनॉमी', 'bn': 'ইকোনমি', 'fil': 'Economy', 'fr': 'Économique', 'tr': 'Ekonomi'},
  'comfortSection': {'ar': 'مريح وفاخر', 'en': 'Comfort & Premium', 'ur': 'آرام دہ اور پریمیم', 'hi': 'कम्फर्ट और प्रीमियम', 'bn': 'কমফোর্ট ও প্রিমিয়াম', 'fil': 'Comfort at Premium', 'fr': 'Confort et Premium', 'tr': 'Konfor ve Premium'},
  'largeSection': {'ar': 'سعة كبيرة وخاص', 'en': 'Large & Special', 'ur': 'بڑی اور خاص', 'hi': 'बड़ा और विशेष', 'bn': 'বড় ও বিশেষ', 'fil': 'Malaki at Espesyal', 'fr': 'Grand et Spécial', 'tr': 'Büyük ve Özel'},
  'otherSection': {'ar': 'أخرى', 'en': 'Other', 'ur': 'دیگر', 'hi': 'अन्य', 'bn': 'অন্যান্য', 'fil': 'Iba pa', 'fr': 'Autre', 'tr': 'Diğer'},
  'personal': {'ar': 'شخصي', 'en': 'Personal', 'ur': 'ذاتی', 'hi': 'व्यक्तिगत', 'bn': 'ব্যক্তিগত', 'fil': 'Personal', 'fr': 'Personnel', 'tr': 'Kişisel'},
  'business': {'ar': 'أعمال', 'en': 'Business', 'ur': 'کاروبار', 'hi': 'व्यापार', 'bn': 'ব্যবসা', 'fil': 'Negosyo', 'fr': 'Professionnel', 'tr': 'İş'},
  'schedule': {'ar': 'جدولة', 'en': 'Schedule', 'ur': 'شیڈول', 'hi': 'शेड्यूल', 'bn': 'সময়সূচি', 'fil': 'Iiskedyul', 'fr': 'Planifier', 'tr': 'Planla'},
  'upcoming': {'ar': 'القادمة', 'en': 'Upcoming', 'ur': 'آنے والی', 'hi': 'आगामी', 'bn': 'আসন্ন', 'fil': 'Paparating', 'fr': 'À venir', 'tr': 'Yaklaşan'},
  'past': {'ar': 'السابقة', 'en': 'Past', 'ur': 'ماضی', 'hi': 'पिछली', 'bn': 'অতীত', 'fil': 'Nakaraan', 'fr': 'Passées', 'tr': 'Geçmiş'},
  'noUpcoming': {'ar': 'لا رحلات مجدولة', 'en': 'No scheduled rides', 'ur': 'کوئی شیڈول سواری نہیں', 'hi': 'कोई निर्धारित सवारी नहीं', 'bn': 'কোনো নির্ধারিত যাত্রা নেই', 'fil': 'Walang nakaiskedyul na biyahe', 'fr': 'Aucun trajet programmé', 'tr': 'Planlanmış yolculuk yok'},
  'noUpcomingSub': {'ar': 'احجز رحلة مسبقاً لتظهر هنا', 'en': 'Reserve a ride to see it here', 'ur': 'یہاں دیکھنے کے لیے سواری بک کریں', 'hi': 'यहाँ देखने के लिए सवारी आरक्षित करें', 'bn': 'এখানে দেখতে একটি যাত্রা সংরক্ষণ করুন', 'fil': 'Mag-reserve ng biyahe para makita ito dito', 'fr': 'Réservez un trajet pour le voir ici', 'tr': 'Burada görmek için yolculuk ayırtın'},
  'scheduled': {'ar': 'مجدولة', 'en': 'Scheduled', 'ur': 'شیڈول شدہ', 'hi': 'निर्धारित', 'bn': 'নির্ধারিত', 'fil': 'Nakaiskedyul', 'fr': 'Programmé', 'tr': 'Planlandı'},
  'somethingWrong': {'ar': 'حدث خطأ ما', 'en': 'Something went wrong', 'ur': 'کچھ غلط ہو گیا', 'hi': 'कुछ गलत हुआ', 'bn': 'কিছু একটা ভুল হয়েছে', 'fil': 'May nagkamali', 'fr': 'Une erreur s\'est produite', 'tr': 'Bir şeyler ters gitti'},
  'back': {'ar': 'رجوع', 'en': 'Back', 'ur': 'واپس', 'hi': 'वापस', 'bn': 'পিছনে', 'fil': 'Bumalik', 'fr': 'Retour', 'tr': 'Geri'},
  'reserveRide': {'ar': 'حجز رحلة', 'en': 'Reserve a Ride', 'ur': 'سواری محفوظ کریں', 'hi': 'सवारी आरक्षित करें', 'bn': 'যাত্রা সংরক্ষণ করুন', 'fil': 'Mag-reserve ng Biyahe', 'fr': 'Réserver un trajet', 'tr': 'Yolculuk Ayırt'},
  'reservePrefix': {'ar': 'احجز', 'en': 'Reserve', 'ur': 'محفوظ کریں', 'hi': 'आरक्षित करें', 'bn': 'সংরক্ষণ', 'fil': 'I-reserve', 'fr': 'Réserver', 'tr': 'Ayırt'},
  'reserveAtLeast2h': {'ar': 'يجب الحجز قبل ساعتين على الأقل', 'en': 'Reservations must be made at least 2 hours in advance', 'ur': 'ریزرویشن کم از کم 2 گھنٹے پہلے کرنا ضروری ہے', 'hi': 'आरक्षण कम से कम 2 घंटे पहले करना होगा', 'bn': 'কমপক্ষে ২ ঘণ্টা আগে সংরক্ষণ করতে হবে', 'fil': 'Dapat mag-reserve nang hindi bababa sa 2 oras nang maaga', 'fr': 'Les réservations doivent être faites au moins 2 heures à l\'avance', 'tr': 'Rezervasyonlar en az 2 saat önceden yapılmalıdır'},
  'cancellationPolicyText': {'ar': 'نضمن وصول السائق في الموعد. يمكنك الإلغاء مجاناً حتى 60 دقيقة قبل الموعد؛ بعدها تُطبّق رسوم الإلغاء تعويضاً للسائق.', 'en': 'We guarantee your driver arrives on time. Cancel free up to 60 minutes before; after that a cancellation fee applies to compensate the driver.', 'ur': 'ہم وقت پر ڈرائیور کی آمد کی ضمانت دیتے ہیں۔ 60 منٹ پہلے تک مفت منسوخی؛ اس کے بعد منسوخی فیس لاگو ہوگی۔', 'hi': 'हम समय पर ड्राइवर के आगमन की गारंटी देते हैं। 60 मिनट पहले तक मुफ्त रद्द; उसके बाद रद्दीकरण शुल्क लागू।', 'bn': 'আমরা সময়মতো চালকের আগমন নিশ্চিত করি। ৬০ মিনিট আগ পর্যন্ত বিনামূল্যে বাতিল; এরপর বাতিল ফি প্রযোজ্য।', 'fil': 'Ginagarantiya naming dumating ang driver sa oras. Libreng kanselahin hanggang 60 minuto bago; pagkatapos nito may bayad sa pagkansela.', 'fr': 'Nous garantissons l\'arrivée à l\'heure du chauffeur. Annulation gratuite jusqu\'à 60 minutes avant ; ensuite des frais s\'appliquent.', 'tr': 'Sürücünüzün zamanında gelmesini garanti ederiz. 60 dakika öncesine kadar ücretsiz iptal; sonrasında iptal ücreti uygulanır.'},
  ...
  'savedPlaces': {'ar': 'العناوين المحفوظة', 'en': 'Saved places', 'ur': 'محفوظ مقامات', 'hi': 'सहेजे गए स्थान', 'bn': 'সংরক্ষিত স্থান', 'fil': 'Mga naka-save na lugar', 'fr': 'Lieux enregistrés', 'tr': 'Kayıtlı yerler'},
  'savedPlacesSub': {'ar': 'المنزل والعمل وأماكنك المفضّلة', 'en': 'Home, work and favorites', 'ur': 'گھر، کام اور پسندیدہ', 'hi': 'घर, काम और पसंदीदा', 'bn': 'বাড়ি, কাজ ও প্রিয়', 'fil': 'Bahay, trabaho at paborito', 'fr': 'Maison, travail et favoris', 'tr': 'Ev, iş ve favoriler'},
  'addPlace': {'ar': 'إضافة عنوان', 'en': 'Add place', 'ur': 'مقام شامل کریں', 'hi': 'स्थान जोड़ें', 'bn': 'স্থান যোগ করুন', 'fil': 'Magdagdag ng lugar', 'fr': 'Ajouter un lieu', 'tr': 'Yer ekle'},
  'placeLabelHint': {'ar': 'مثال: المنزل، العمل، الجامعة…', 'en': 'e.g. Home, Work, University…', 'ur': 'مثلاً گھر، دفتر…', 'hi': 'जैसे घर, कार्यालय…', 'bn': 'যেমন বাড়ি, অফিস…', 'fil': 'hal. Bahay, Trabaho…', 'fr': 'ex. Maison, Travail…', 'tr': 'ör. Ev, İş…'},
  'placeHome': {'ar': 'المنزل', 'en': 'Home', 'ur': 'گھر', 'hi': 'घर', 'bn': 'বাড়ি', 'fil': 'Bahay', 'fr': 'Maison', 'tr': 'Ev'},
  'placeWork': {'ar': 'العمل', 'en': 'Work', 'ur': 'کام', 'hi': 'कार्यालय', 'bn': 'কাজ', 'fil': 'Trabaho', 'fr': 'Travail', 'tr': 'İş'},
  ...
  'safetyPreferencesSub': {'ar': 'اختر وفعّل أدوات الأمان المفضّلة لديك.', 'en': 'Choose and enable your favorite safety tools.'},
  'trustedContacts': {'ar': 'جهات الاتصال الموثوقة', 'en': 'Trusted contacts'},
  'trustedContactsSub': {'ar': 'شارك حالة رحلتك مع عائلتك وأصدقائك بنقرة واحدة.', 'en': 'Share your trip status with family and friends in one tap.'},
  'pinVerification': {'ar': 'التحقق برمز PIN', 'en': 'PIN verification'},
  'pinVerificationSub': {'ar': 'تأكّد من ركوب السيارة الصحيحة برمز.', 'en': 'Use a PIN to make sure you get in the right car.'},
  'pinVerificationBody': {'ar': 'عند تفعيل التحقق برمز PIN، تُعطى رمزاً مكوّناً من 4 أرقام تخبر به السائق قبل بدء الرحلة. لن تبدأ الرحلة إلا بعد إدخال الرمز الصحيح، ما يضمن أنك ركبت السيارة الصحيحة. يستخدم HANCR أيضاً رمز تسليم آمن عند نقل الطرود.', 'en': 'When PIN verification is on, you get a 4-digit code to give the driver before the trip starts. The trip only begins once the correct code is entered, ensuring you got in the right car. HANCR also uses a secure handover code for parcel deliveries.'},
  'rideCheck': {'ar': 'فحص الرحلة', 'en': 'RideCheck'},
  'rideCheckSub': {'ar': 'إدارة رسائل الاطمئنان أثناء الرحلة.', 'en': 'Manage your safety check-in messages.'},
  'rideCheckBody': {'ar': 'يرصد فحص الرحلة المواقف غير المتوقعة (توقّف طويل أو خروج عن المسار) ويطمئن عليك برسالة تتيح لك طلب المساعدة بسرعة أو تأكيد أنك بخير.', 'en': 'RideCheck detects unexpected events (a long stop or going off-route) and checks in on you with a message so you can quickly get help or confirm you\'re okay.'},
  'safetyTips': {'ar': 'نصائح الأمان', 'en': 'Safety tips'},
  'safetyTipsSub': {'ar': 'اركب بثقة مع نصائح HANCR.', 'en': 'Ride with confidence with HANCR\'s tips.'},
  'safetyTip1': {'ar': 'تحقّق من اسم السائق ولوحة السيارة قبل الركوب.', 'en': 'Verify the driver\'s name and plate before getting in.'},
  'safetyTip2': {'ar': 'انتظر السيارة في مكان آمن ومضاء.', 'en': 'Wait for your car in a safe, well-lit spot.'},
  'safetyTip3': {'ar': 'شارك رحلتك مع جهة موثوقة عبر زر المشاركة.', 'en': 'Share your trip with a trusted contact using the share button.'},
  'safetyTip4': {'ar': 'في الطوارئ استخدم زر SOS داخل التطبيق.', 'en': 'In an emergency, use the in-app SOS button.'},
  'safetyAtHancr': {'ar': 'الأمان في HANCR', 'en': 'Safety at HANCR'},
  'safetyAtHancrSub': {'ar': 'افهم كيف نحرص على سلامتك.', 'en': 'Understand how we stand for your safety.'},
  'safetyAtHancrBody': {'ar': 'نتحقّق من هوية كل سائق ووثائقه قبل قبوله، ونراقب الرحلات لحظياً، ونوفّر دعماً بشرياً على مدار الساعة. سلامتك أساس المنصّة لا ميزة إضافية.', 'en': 'We verify every driver\'s identity and documents before approval, monitor trips in real time, and provide 24/7 human support. Your safety is the foundation of the platform, not an add-on.'},
  'prefAutoShare': {'ar': 'مشاركة الرحلة تلقائياً', 'en': 'Auto-share trips'},
  'prefAutoShareSub': {'ar': 'مشاركة كل رحلة مع جهاتك الموثوقة تلقائياً.', 'en': 'Automatically share each trip with your trusted contacts.'},
  'prefPinRequired': {'ar': 'طلب رمز PIN دائماً', 'en': 'Always require PIN'},
  'prefPinRequiredSub': {'ar': 'اطلب رمز تحقق قبل بدء كل رحلة.', 'en': 'Require a verification PIN before every trip starts.'},
  'prefRideCheck': {'ar': 'تفعيل فحص الرحلة', 'en': 'Enable RideCheck'},
  'prefRideCheckSub': {'ar': 'اطمئنان تلقائي عند المواقف غير المتوقعة.', 'en': 'Automatic check-ins on unexpected events.'},
  ...
  'topicAccountBody': {'ar': 'إدارة بياناتك الشخصية، صورة الملف، البريد، وتسجيل الخروج من شاشة الحساب → تعديل/الإعدادات.', 'en': 'Manage your personal details, profile photo, email, and sign-out from Account → Edit/Settings.'},
  'topicPayments': {'ar': 'المدفوعات', 'en': 'Payments'},
  'topicPaymentsBody': {'ar': 'أضف رصيداً للمحفظة، استخدم أكواد الهدايا والخصم، وراجع سجل معاملاتك من شاشة المحفظة.', 'en': 'Top up your wallet, use gift and promo codes, and review your transactions from the Wallet screen.'},
  'topicSafety': {'ar': 'الأمان', 'en': 'Safety'},
  'topicSafetyBody': {'ar': 'فعّل جهات الاتصال الموثوقة، التحقق برمز PIN، وفحص الرحلة من مركز الأمان.', 'en': 'Enable trusted contacts, PIN verification, and RideCheck from the Safety Hub.'},
  'topicGuides': {'ar': 'الأدلة', 'en': 'Guides'},
  'topicGuidesBody': {'ar': 'تعلّم كيفية حجز رحلة، تتبّع سائقك، وتقييم رحلتك خطوة بخطوة.', 'en': 'Learn how to book a ride, track your driver, and rate your trip step by step.'},
  'topicMap': {'ar': 'مشكلة في الخريطة', 'en': 'Map issue'},
  'topicMapBody': {'ar': 'إذا كان موقعك أو وجهتك غير دقيقين، حرّك الدبوس على الخريطة يدوياً أو ابحث عن العنوان. للإبلاغ عن خطأ تواصل مع الدعم.', 'en': 'If your pickup or destination is inaccurate, move the pin manually on the map or search the address. To report an error, contact support.'},
  ...
  'shortcutsSub': {'ar': 'أماكنك المتكرّرة بنقرة واحدة', 'en': 'Your frequent places in one tap'},
  'controlPrivacy': {'ar': 'التحكّم والخصوصية', 'en': 'Control & privacy'},
  'privacy': {'ar': 'الخصوصية', 'en': 'Privacy'},
  'privacySub': {'ar': 'تحكّم في بياناتك ومشاركتها', 'en': 'Control your data and how it is shared'},
  'prShareTrip': {'ar': 'مشاركة حالة الرحلة', 'en': 'Share trip status'},
  'prShareTripSub': {'ar': 'السماح للمقرّبين بمتابعة رحلتك', 'en': 'Let trusted contacts follow your trip'},
  'prPersonalized': {'ar': 'تجربة مخصّصة', 'en': 'Personalized experience'},
  'prPersonalizedSub': {'ar': 'اقتراحات بناءً على رحلاتك', 'en': 'Suggestions based on your trips'},
  'privacyPolicy': {'ar': 'سياسة الخصوصية', 'en': 'Privacy policy'},
  'accessibility': {'ar': 'إمكانية الوصول', 'en': 'Accessibility'},
  'accessibilitySub': {'ar': 'خيارات تسهّل الاستخدام', 'en': 'Options that make the app easier to use'},
  'acLargeText': {'ar': 'نص أكبر', 'en': 'Larger text'},
  'acLargeTextSub': {'ar': 'تكبير حجم الخط في التطبيق', 'en': 'Increase the font size in the app'},
  'acReduceMotion': {'ar': 'تقليل الحركة', 'en': 'Reduce motion'},
  'acReduceMotionSub': {'ar': 'تقليل الرسوم المتحرّكة', 'en': 'Minimize animations'},
  ...
  'cmEmailSub': {'ar': 'العروض والإيصالات عبر البريد', 'en': 'Offers and receipts by email'},
  ...
  'chooseTeamSub': {'ar': 'ألوان بلدك في رحلتك', 'en': "Your country's colors on your ride"},
  'switchAccount': {'ar': 'تبديل الحساب', 'en': 'Switch account'},
  'switchAccountConfirm': {'ar': 'سيتم تسجيل خروجك للدخول بحساب آخر. هل تريد المتابعة؟', 'en': "You'll be signed out to log in with another account. Continue?"},
  'signOut': {'ar': 'تسجيل الخروج', 'en': 'Sign out'},
  'signOutConfirm': {'ar': 'هل تريد تسجيل الخروج من حسابك؟', 'en': 'Do you want to sign out of your account?'},
  ...
  'checkupTitle': {'ar': 'أكمل فحص حسابك', 'en': 'Complete your account checkup'},
  'checkupSub': {'ar': 'راجع إعدادات الأمان لحماية حسابك', 'en': 'Review your security settings to protect your account'},
  ...
  'securityInfo': {'ar': 'نستخدم رقم هاتفك للتحقّق من هويتك عند الدخول. لمزيد من الأمان، لا تشارك رمز التحقّق مع أحد.', 'en': 'We use your phone number to verify your identity at sign-in. For your security, never share your verification code.'},
  'signOutEverywhere': {'ar': 'تسجيل الخروج من كل الأجهزة', 'en': 'Sign out of all devices'},
  'privacyDataInfo': {'ar': 'نحن نحترم خصوصيتك. يمكنك مراجعة كيفية جمع بياناتك واستخدامها، وطلب نسخة منها أو حذفها في أي وقت.', 'en': 'We respect your privacy. You can review how your data is collected and used, and request a copy or deletion at any time.'},

  // ─── الدفعة الثانية: العائلة ───
  'family': {'ar': 'العائلة', 'en': 'Family'},
  'familySub': {'ar': 'أضف أفراد عائلتك وأدِر رحلاتهم', 'en': 'Add family members and manage their rides'},
  'famTitle': {'ar': 'ملف عائلي واحد', 'en': 'One family profile'},
  'famSub': {'ar': 'ادعُ عائلتك لإدارة الرحلات والدفع ومتابعة الأمان معاً.', 'en': 'Invite your family to manage rides, payments, and safety together.'},
  'famTeenSafety': {'ar': 'أمان حساب المراهق', 'en': 'Teen account safety'},
  'famTeenSafetySub': {'ar': 'حساب مخصّص وآمن للمراهقين', 'en': 'A dedicated, safe account for teens'},
  'famFollow': {'ar': 'تتبّع حيّ', 'en': 'Live tracking'},
  'famFollowSub': {'ar': 'تابع رحلات أفراد عائلتك مباشرةً', 'en': "Follow your family's trips in real time"},
  'famPay': {'ar': 'الدفع للعائلة', 'en': 'Family payment'},
  'famPaySub': {'ar': 'طريقة دفع مشتركة لكل الرحلات', 'en': 'A shared payment method for all rides'},
  'famLimits': {'ar': 'حدود الإنفاق', 'en': 'Spending limits'},
  'famLimitsSub': {'ar': 'تحكّم في ميزانية رحلات العائلة', 'en': "Control your family's ride budget"},
  ...
  'famTeenSub': {'ar': 'يحتاج موافقة وليّ الأمر', 'en': 'Requires parental consent'},
  'continue_': {'ar': 'متابعة', 'en': 'Continue'},
  'famShareMsg': {'ar': 'انضمّ إلى عائلتي على HANCR! حمّل التطبيق من hancr.com', 'en': 'Join my family on HANCR! Download the app at hancr.com'},
  'famInviteSent': {'ar': 'تم إرسال الدعوة', 'en': 'Invitation sent'},

  // ─── الدفعة الثانية: اختر فريقك ───
  'teamApplied': {'ar': 'GOAL! ستظهر ألوان فريقك في رحلتك', 'en': "GOAL! Your team's colors will show on your ride"},
  'teamMena': {'ar': 'الشرق الأوسط وشمال أفريقيا', 'en': 'Middle East & North Africa'},
  ...
  'co2Note': {
    'ar': 'تقدير تقريبي يُحتسب من عدد رحلاتك بمتوسطات معروفة. مشاركة الرحلات والمركبات الكهربائية تقلّل أثرك أكثر.',
    'en': 'A rough estimate based on your ride count using known averages. Shared rides and EVs reduce your footprint further.'
  },
  'kg': {'ar': 'كجم', 'en': 'kg'},
  'km': {'ar': 'كم', 'en': 'km'},
  ...
  'familyNameHint': {'ar': 'اسم المجموعة (مثل: عائلتي)', 'en': 'Group name (e.g. My family)'},
  'inviteViaShare': {'ar': 'دعوة عبر المشاركة', 'en': 'Invite via share'},
  'familyMembers': {'ar': 'الأعضاء', 'en': 'Members'},
  'roleOwner': {'ar': 'المالك', 'en': 'Owner'},
  'memberPhoneHint': {'ar': 'رقم هاتف العضو (مسجَّل في HANCR)', 'en': "Member's phone (registered on HANCR)"},
  'spendLimit': {'ar': 'حدّ الإنفاق الشهري', 'en': 'Monthly spend limit'},
  'spendLimitHint': {'ar': 'الحدّ الشهري (اتركه فارغاً لبلا حدّ)', 'en': 'Monthly limit (leave empty for none)'},
  'removeMemberConfirm': {'ar': 'إزالة هذا العضو من المجموعة؟', 'en': 'Remove this member from the group?'},
  'deleteFamily': {'ar': 'حذف المجموعة', 'en': 'Delete group'},
  'deleteFamilyConfirm': {'ar': 'حذف المجموعة العائلية نهائياً؟', 'en': 'Permanently delete the family group?'},
  'leaveFamily': {'ar': 'مغادرة المجموعة', 'en': 'Leave group'},
  'leaveFamilyConfirm': {'ar': 'مغادرة هذه المجموعة العائلية؟', 'en': 'Leave this family group?'},
  ...
  'twoFactorInfo': {
    'ar': 'أضِف طبقة حماية ثانية: بعد رمز الهاتف، تُدخل رمزاً من تطبيق مُصادِق (Google Authenticator/Authy).',
    'en': 'Add a second layer of protection: after your phone code, enter a code from an authenticator app (Google Authenticator/Authy).'
  },
  'enableTwoFa': {'ar': 'تفعيل التحقق بخطوتين', 'en': 'Enable two-factor'},
  'disableTwoFa': {'ar': 'تعطيل التحقق بخطوتين', 'en': 'Disable two-factor'},
  'twoFaSecretLabel': {'ar': 'أدخل هذا السرّ في تطبيق المُصادِق', 'en': 'Enter this secret in your authenticator app'},
  'enterAuthCode': {'ar': 'أدخل الرمز المكوّن من 6 أرقام', 'en': 'Enter the 6-digit code'},
  'recoveryCodesTitle': {'ar': 'أكواد الاسترداد', 'en': 'Recovery codes'},
  'recoveryCodesNote': {
    'ar': 'احفظ هذه الأكواد في مكان آمن. كل كود يُستخدم مرّة واحدة لاستعادة الدخول عند فقد المُصادِق.',
    'en': 'Save these codes somewhere safe. Each can be used once to recover access if you lose your authenticator.'
  },
  'twoFaEnabled': {'ar': 'تم تفعيل التحقق بخطوتين', 'en': 'Two-factor enabled'},
  'twoFaDisabled': {'ar': 'تم تعطيل التحقق بخطوتين', 'en': 'Two-factor disabled'},
  ...
  'devicesInfo': {
    ...
    'en': 'These devices are signed in to your account. Revoke any you don\'t recognize.'
  },
  ...
  'revokeDeviceConfirm': {'ar': 'تسجيل الخروج من هذا الجهاز؟', 'en': 'Sign out of this device?'},

  // ─── إنجاز المؤجَّل: تبديل الحسابات ───
  'addAccount': {'ar': 'إضافة حساب آخر', 'en': 'Add another account'},
  'addAccountConfirm': {
    'ar': 'سيتم تسجيل خروجك لتسجيل الدخول بحساب آخر (يبقى حسابك الحالي محفوظاً للتبديل).',
  ...
  'legalLicenses': {'ar': 'تراخيص المصادر المفتوحة', 'en': 'Open-source licenses'},
  'earnDriving': {'ar': 'اربح بالقيادة', 'en': 'Earn by driving'},
  'earnTitle': {'ar': 'قُد واربح مع HANCR', 'en': 'Drive and earn with HANCR'},
  'earnSub': {'ar': 'انضمّ كسائق وحقّق دخلاً بمرونة كاملة.', 'en': 'Join as a driver and earn on your own schedule.'},
  'earnB1': {'ar': 'دخل تنافسي', 'en': 'Competitive earnings'},
  'earnB1Sub': {'ar': 'احتفظ بحصّة أكبر من كل رحلة', 'en': 'Keep more of every fare'},
  'earnB2': {'ar': 'مرونة كاملة', 'en': 'Full flexibility'},
  'earnB2Sub': {'ar': 'اعمل متى وأينما تشاء', 'en': 'Work whenever and wherever you want'},
  'earnB3': {'ar': 'نموّ مستمر', 'en': 'Keep growing'},
  'earnB3Sub': {'ar': 'مكافآت وحوافز للسائقين النشطين', 'en': 'Bonuses and incentives for active drivers'},
  'downloadDriverApp': {'ar': 'حمّل تطبيق السائق', 'en': 'Download the driver app'},
  'simpleMode': {'ar': 'الوضع البسيط', 'en': 'Simple mode'},
  'simpleModeInfo': {'ar': 'يُكبّر خطوط التطبيق ويبسّط الواجهة لتسهيل الاستخدام لكبار السن.', 'en': 'Enlarges the app text and simplifies the interface for easier use by elders.'},
  'simpleModeToggle': {'ar': 'تفعيل الوضع البسيط (خط أكبر)', 'en': 'Enable simple mode (larger text)'},
  ...
  'complaintDescHint': {'ar': 'صف المشكلة بالتفصيل…', 'en': 'Describe the issue in detail…'},
  ...
  'rideProfilesInfo': {'ar': 'اختر الملف الافتراضي لرحلاتك وفواتيرها.', 'en': 'Choose the default profile for your rides and billing.'},
  ...
  'profileBusinessSub': {'ar': 'تُفوتر على حساب الشركة', 'en': 'Billed to your company account'},
  ...
  'billingEmailHint': {'ar': 'بريد الفوترة (اختياري)', 'en': 'Billing email (optional)'},
  ...
  'payWalletSub': {'ar': 'ادفع من رصيد محفظتك', 'en': 'Pay from your wallet balance'},
