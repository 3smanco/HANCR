...
const steps = [
  ...
  ['Log redaction check', 'node', ['tools/check-log-redaction.mjs']],
  ...
  ['Build rider-api production bundle', 'npx', ['nx', 'build', 'rider-api', '--configuration=production']],
  ['Build driver-api production bundle', 'npx', ['nx', 'build', 'driver-api', '--configuration=production']],
  ['Build admin-api production bundle', 'npx', ['nx', 'build', 'admin-api', '--configuration=production']],
